      ...
      <div id="carouselExampleInterval" className="carousel slide" data-bs-ride="carousel" >
        <div className="carousel-inner">
          ...
          <div className="carousel-item active" data-bs-interval="1000">
            ...
            <img src="/assets/20.jpg"  className=" carousel-img "  alt="Loading..." />
            </div>
                ...
                <div className="row">
                 ...
                 <div >
                  ...
                  <div className="col-12 col-lg-3 justify-content-center align-content-center">
                    <div className="pb-3">
                       <img src="/assets/29.png" className='my-3 ms-2 logo-icon' width="250" alt="Loading img" />
                    </div>
          ...
          <div className="carousel-item " data-bs-interval="2000">
           <div className=" carousel-img-wrapper ">
            <img src="/assets/18.jpg"  className=" carousel-img " alt="Loading..." />
           </div>
            <div className="carousel-caption">
                ...
                <div className="carousel-item " data-bs-interval="2000">
           <div className=" carousel-img-wrapper ">
            <img src="/assets/16.jpg"  className=" carousel-img " alt="Loading..." />
         </div>
            <div className="carousel-caption">
                ...
                <div className="carousel-item " data-bs-interval="2000">
           <div className=" carousel-img-wrapper ">
            <img src="/assets/23.jpg"  className=" carousel-img " alt="Loading..." />
          </div>        
          <div className="carousel-caption">
             ...
             <div className="carousel-item " data-bs-interval="2000">
          <div className=" carousel-img-wrapper ">
            <img src="/assets/5.jpg"  className=" carousel-img " alt="Loading..." />
          </div>
            <div className="carousel-caption">
 ...
 <div className="btn-container fade-in mt-3">
  ...
  <div className="container">
    ...
    <div className="row align-items-center">
      ...
      <div className="col-lg-3 col-12">
        <div className="work-img m-4">
          <img src="/assets/23.jpg" alt="Loading..." />
        </div>
      </div>
     ...
     <section >
        ...
        <div className="row g-0">
          ...
          <div className="col-lg-6 col-12 justify-content-center align-content-center">
            <img src="/assets/18.jpg" className='p-3 rounded-5' alt="Loading..." height="100%" width="100%" />
          </div>
