...
.catch(err=>console.log("Error"+err))
 ...
 <div className="col-lg-4 mt-3 p-5 ">
  ...
  <div className="row g-0  ">
    ...
    <div className="col-lg-3 col-4 m-2" >
     <Link to="/Totalusers"> <img className="card-img w-75 " src="/assets/6.png" alt="Upload image" /> </Link> 
      <label className=" form-label mt-3  fw-bold">Total Users</label>
     </div>
     <div className="col-lg-3 col-4 m-2" >
      <Link to="/Totaltask"><img className="card-img w-75 " src="/assets/7.png" alt="Upload image" /> </Link>
      <label className=" form-label mt-3  fw-bold">Total Waste Tasks</label>
     </div>

     <div className="col-lg-3 col-4 m-2">
     <Link to="/Completedtask"> <img className="card-img w-75 " src="/assets/9.png" alt="Upload image" /></Link>
       <label className=" form-label mt-3  fw-bold">Completed Tasks</label>
     
     </div>

     <div className="col-lg-3 col-4 m-2">
      <Link to="/Workerdetails"> <img className="card-img w-75 " src="/assets/10.png" alt="Upload image" /></Link>
 ...
 <div className="col-lg-4 mt-3 p-5 ">
  ...
  <div className="row g-0  ">
    ...
    <div className="col-lg-3 col-4 m-2 " >
      <Link to="/Useradd"> <img className="card-img w-75 " src="/assets/15.png" alt="Upload image" /></Link>
      <label className=" form-label fw-bold mt-3">Users add </label>
     </div>
     <div className="col-lg-3 col-4  m-2" >
      <Link to="/Wasteadd"> <img className="card-img w-75 " src="/assets/14.png" alt="Upload image" /></Link>
      <label className=" form-label fw-bold mt-3">Waste Category </label>
     </div>
     <div className="col-lg-3 col-4 m-2">
         <Link to="/Workeradd"> <img className="card-img w-75 " src="/assets/11.png" alt="Upload image" />   </Link>
        <label className=" form-label fw-bold mt-3">Worker / Driver Add</label>
    
    </div>
     <div className="col-lg-3 col-4 m-2"> 
    <Link to="/Comment">  <img className="card-img w-75 " src="/assets/12.png" alt="Upload image" /></Link>
